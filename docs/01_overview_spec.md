...
:   1. 管理者はログイン画面を表示する。
    ...
    7. サービス管理シスムテはメイン画面を表示する。

拡張シナリオ
:   4a. Google認証に失敗した場合Google認証システムは認証失敗を表示する。<br>
    5a. サービス管理システムは、トップ画面を表示する。
...
:   1. 管理者は引数でユーザー名、パスワード、Gメールを指定してGmail認証ユーザー登録機能を実行する。
    ...
    7. サービス管理システムは、トークンおよび有効期限を検証する。
    8. サービス管理システムは、ユーザー情報を登録する。
    9. 管理者はユーザー情報を確認する。

拡張シナリオ
:   7a. トークンが不正な場合、サービス管理システムはエラーメッセージを表示する。<br>
    7b. トークンの有効期限が切れている場合、サービス管理システムはエラーメッセージを表示する。<br>
